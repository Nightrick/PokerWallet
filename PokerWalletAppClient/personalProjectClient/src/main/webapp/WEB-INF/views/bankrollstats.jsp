...
<div class="header">    
  <div class="loginButtons">
	<c:if test="${not loggedIn}">
		...
		<h1 style="text-align: center"> Bankroll Stats!</h1> 
  		</div>
	</c:if>
	<c:if test="${loggedIn}">
	...
	<c:if test="${not loggedIn}">
		<div class="form-inline">
  		...
  		<h3 style="text-align: center">Please sign in to view your bankroll stats!</h3>
	</c:if>
	<c:if test="${loggedIn}">
		<div class="form-inline">
  			<form action="/" method="POST">
...
<c:if test="${loggedIn}">
	<h4 style="text-align: center">Your bankroll stats as of *date*: </h4>
	<h3 style="text-align: center">${message}</h3>
	<h4 style="text-align: center">List of Date/Time - Bankroll/NetProfit to be displayed here. </h4>
</c:if>
